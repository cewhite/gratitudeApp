In this day and age the last thing we see before we go to sleep is our phone and it's often the first thing we look at in the morning. The Gratitude App is meant to be used at either or both of those times. This simple app allows you to list and give thanks for all the things you hold dear. An easy way to count it all joy with a simple click of a button. 
...
The goal of this page was to create a full C.R.U.D. app. For version 2.0, I'll be breaking down the app.js into multiple components and continue optimal styling.
...
To Joe for helping me press the reset button and actually get a finished project and to my classmates for all the support!
